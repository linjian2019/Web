 ...
 */
function practice31(str) {
   return typeof str === 'string' && str.split('').reverse().join('') === str;
}
let a31 = 'aba';
let b31 = 'abca';
let result311 = practice31(a31);
let result321 = practice31(b31);
console.log(result311);
...
let a41 = [1,2,3];
let b41 = [2,3,4];
let result41 = practice41(a41,b41);
